...
public record EncryptedObjectSetting : EncryptableObjectSetting
{
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    public static EncryptedObjectSetting CreateEncrypted<T>(in SecureString vaultKey, T value)
    {
    ...
    /// <param name="valueType"></param>
    /// <returns></returns>
    public static EncryptedObjectSetting CreateEncryptedFromBytes(in SecureString vaultKey,
        ...
        Type valueType)
    {
        ...
        return CreateEncryptedFromBytes(
            vaultKey: vaultKey,
            unencryptedObjectData: unencryptedBytes,
            valueType: valueType,
